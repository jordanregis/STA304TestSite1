...
From the list of available ces studies, we chose ces2015_web as the study for this paper, this was mainly due to the rich variety of questions answered in this survey.
...
Lastly, with better planning, I could have created an appendix using GitHub that contained all the coding in this study so that reproducibility was as easy as possible. This would have allowed the paper to flow much better without being interrupted by large coding chunks making the reading a lot easier.
...
However, it was also displayed throughout the study due to my lack of knowledge working with GitHub repositories and general level of unsureness about whether or not it worked properly. Sorry!
